    ...
    <div className="page-stack">
      <section className="hero-panel compact">
        ...
        <div className="hero-pills">
          <button className={`subtab-pill ${shadowTab === "selector" ? "is-active" : ""}`} onClick={() => { setShadowTab("selector"); onRefreshPayload(); }}>目标歌单</button>
          <button className={`subtab-pill ${shadowTab === "generator" ? "is-active" : ""}`} onClick={() => { setShadowTab("generator"); onRefreshPayload(); }}>候选歌曲</button>
          <button className={`subtab-pill ${shadowTab === "status" ? "is-active" : ""}`} onClick={() => { setShadowTab("status"); onRefreshStatus(); }}>生成状态</button>
        </div>
      </section>
        ...
        <section className="two-column">
          <div className="panel">
            <div className="panel-head">
              ...
              <button className="ghost-button small" onClick={onRefreshPayload}>刷新</button>
            </div>
        ...
        <section className="page-stack">
          <div className="command-panel">
            ...
            <div className="toolbar">
              ...
              <span className="toolbar-meta">候选 {shadowCandidates.length} / 已选 {selectedCandidateIds.size}</span>
            </div>
          </div>
      ...
      {shadowTab === "status" ? (
        <section className="page-stack">
          <div className="toolbar">
            <span className="toolbar-meta">最近生成时间 {lastBuild?.generated_at || "-"}</span>
            <span className="toolbar-meta">最近生成数量 {lastBuild?.generated_count || 0} 首</span>
