...
export function RelationRoute({
  ...
  return (
    <div className="page-stack">
      ...
      {relationTab === "friend" ? (
        <div className="page-stack">
          <section className="hero-panel friend-hero">
            ...
            <div className="hero-pills wrap">
              <span className="status-pill">关系温度 {friendData?.relation_temperature?.label || "--"}</span>
              <span className="status-pill">分值 {friendData?.relation_temperature?.score || 0}</span>
            </div>
          </section>
      ...
      {relationTab === "self" ? (
        <div className="page-stack">
          <section className="hero-panel compact">
            ...
            <div className="hero-pills wrap">
              <span className="status-pill">社交标签 {selfData?.social_tag || "--"}</span>
              <span className="status-pill">核心好友 {selfData?.core_friend_name || "--"}</span>
            </div>
          </section>
          <section className="metric-grid">
          ...
          <div className="metric-grid structure-metric-grid">
